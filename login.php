        ...
        <div class="container-fluied" >
            <div class="row justify-content-center ">
                <div class="col-md-4 col-sm-6">
                    ...
                    <form action="login.php" method="post" class="shadow-lg shadow-intensity-xl rounded p-4 mb-5 text-white heightt bg-dark">
                        ...
                        <!-- <div class="mb-2 mt-4">
                            <label for="email" class="form-label fw-bold">New to Library ? <a class="ared" href="user_reg.php">Join Now </a></label>
                        </div> -->
                    </form>
                </div>
            </div>
