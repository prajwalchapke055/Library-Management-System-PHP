...
<body>
	...
	<!-- <h5 class="ms-5 mt-2"><?php //echo $_SESSION['User_uemail'];?></h5> -->
    
    <div class="container-fluid py-4 ">
        <h1 class="ms-5 mt-2">Cuurently Issued Books</h1> 
    <hr>
    </div>
      ...
      <table class="table  " id="myTable">
        ...
        <tbody>
          <?php
            ...
            $newmail=$_SESSION['User_uemail'];
            $sql1 = "select * from issuebook where user_mail='$newmail'";
            $result = mysqli_query($conn, $sql1);
            while ($row = mysqli_fetch_row($result)) {
              $id = $row[0];
              $bookisbn = $row[1];
