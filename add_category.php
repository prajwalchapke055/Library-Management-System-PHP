...
if (isset($_POST['submit'])) {
  ...
  $existSql = "select * from category where cname='$cat'  ";
  $result = mysqli_query($conn, $existSql);
  $numExistsRow = mysqli_num_rows($result);
  if($numExistsRow>0) 
  {
    echo ' <div class="alert alert-danger alert-dismissible fade show" role="alert">  <strong>Category Already Present...:( || </strong> 
        ...
        <div class="col-11 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration"
            ...
            <div class="card-body p-4 p-md-5">
              <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Add Book Category</h3>
              ...
              <form action="add_category.php" method="post">
                ...
                <div class="row">
                  ...
                  <div class="mt-4 pt-2">
                    <input class="btn btn-primary btn-lg" name="submit" type="submit" value="Add Category" />
                  </div>
                </div>
            ...
            <tr>
              ...
              <td>
                <button type="submit" name="edit" class="btn btn-primary  "><a class="text-decoration-none text-white"
                    href="update_category.php?abc=<?php echo base64_encode($id) ?>">Edit</a></button>
                <button type="submit" name="delete" class="btn btn-danger "><a class="text-decoration-none text-white"
                    href="delete_category.php?abc=<?php echo base64_encode($id); ?>">Delete</a></button>
              </td>
            </tr>
